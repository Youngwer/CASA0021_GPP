...
// Create the Web server instance and Preferences object
WebServer server(80);
...
void setup() {
  ...
  // Read the saved WiFi information from the Flash
...
void startAPMode() {
  ...
  Serial.println("\nPlease connect to the hotspot with your mobile phone or computer and then visit the following address to inout WiFi information：");
...
void handleConfigure() {
  ...
  Serial.println("- Password length: " + String(password.length()) + "charactors");
