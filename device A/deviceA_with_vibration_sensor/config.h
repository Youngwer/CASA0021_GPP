...
#define SW420_PIN 34
const char* MQTT_TOPIC_ISREADING_A = "student/ucfnwy2/DeviceA/isReading";          // 改为DeviceB
const char* MQTT_TOPIC_TOTALDAILYTIME_A = "student/ucfnwy2/DeviceA/totalDailyTime"; // 改为DeviceB

const char* MQTT_TOPIC_ISREADING_B = "student/ucfnwy2/DeviceB/isReading";          // 交换为DeviceA
const char* MQTT_TOPIC_TOTALDAILYTIME_B = "student/ucfnwy2/DeviceB/totalDailyTime"; // 交换为DeviceA

const char* MQTT_TOPIC_ISTOUCH = "student/ucfnwy2/isTouch";
extern bool isYellowColor;      // 当前灯光是否为黄色（false=粉色）
...
const unsigned long VIBRATION_COOLDOWN = 3000;     // 振动检测冷却时间（毫秒）
// 全局对象声明（在主文件中实例化）
extern Servo servo1;
extern Servo servo2;
