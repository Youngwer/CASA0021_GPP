...
const char* MQTT_TOPIC_ISREADING_B = "student/ucfnwy2/DeviceA/isReading";          // 交换为DeviceA
const char* MQTT_TOPIC_TOTALDAILYTIME_B = "student/ucfnwy2/DeviceA/totalDailyTime"; // 交换为DeviceA
